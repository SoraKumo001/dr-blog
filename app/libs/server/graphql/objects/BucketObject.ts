import { builder, type BuilderType } from "../builder";
import type { ObjectFieldBuilder } from "@pothos/core";
import type { BucketObject } from "firebase-storage";

export const EncryptionObjectType =
  builder.objectRef<BucketObject["encryption"]>("EncryptionObject");
export const CorsObjectType =
  builder.objectRef<BucketObject["cors"][0]>("CorsObject");
export const BucketObjectType = builder.objectRef<BucketObject>("BucketObject");

EncryptionObjectType.implement({
  fields: (
